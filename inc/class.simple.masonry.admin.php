...
class SimpleMasonryAdmin {
          ...
          public function __construct () {
           ...
           add_action("admin_menu", array($this,'simple_masonry_admin'));
           add_action("admin_init", array($this,'simple_masonry_admin_settings'));

          }

          public function simple_masonry_settings() {
          ...
          public function simple_masonry_admin() {
              add_submenu_page("options-general.php","Simple Masonry Layout", "Simple Masonry Layout", "manage_options", "simple_masonry_layout", array($this,'simple_masonry_settings'));
            
          }

          public function sm_layout_shortcode() {
              ?>
                <ul>
          ...
          public function sm_post_per_field() {
              ?>
                  <input type="number" name="simple_post_per_page" id="simple_post_per_page" value="<?php echo get_option('simple_post_per_page');?>"  min="1" step="1" /><br/><i>Limit number of posts to be displayed. Default : Settings -> Reading.</i>
              <?php
          }

          public function sm_post_orderby_field() {
          ...
          public function sm_post_order_field() {
        ...
        <?php
          ...
          public function sm_post_darkbox_field() {
              ?>
          ...
          public function sm_post_author_field() {
          ?>
          ...
          public function sm_post_comment_field() {
            ?>
           ...
           public function sm_post_title_field() {
              ?>
          ...
          public function simple_masonry_admin_settings() {
              add_settings_section("simple_masonry_settings_section", " ", null, "simple_masonry_options");
              add_settings_field("simple_masonry_shortcode", "Shortcodes", array($this,'sm_layout_shortcode'), "simple_masonry_options", "simple_masonry_settings_section");
              add_settings_field("simple_post_per_page", "Posts To Display", array($this,'sm_post_per_field'), "simple_masonry_options", "simple_masonry_settings_section");
              add_settings_field("simple_post_orderby", "Posts Order By", array($this,'sm_post_orderby_field'), "simple_masonry_options", "simple_masonry_settings_section");
              add_settings_field("simple_post_order", "Posts Order", array($this,'sm_post_order_field'), "simple_masonry_options", "simple_masonry_settings_section");
              add_settings_field("simple_post_darkbox", "Check if you want to display Darkbox Gallery Popup ", array($this,'sm_post_darkbox_field'), "simple_masonry_options", "simple_masonry_settings_section");
              add_settings_field("simple_post_author", "Check if you want to display  Post Author ", array($this,'sm_post_author_field'), "simple_masonry_options", "simple_masonry_settings_section");
              add_settings_field("sm_post_comment", "Check if you want to display  Post Comments ", array($this,'sm_post_comment_field'), "simple_masonry_options", "simple_masonry_settings_section");
              add_settings_field("sm_post_title", "Check if you want to display Post Title URL in gallery ",array($this,'sm_post_title_field'), "simple_masonry_options", "simple_masonry_settings_section");


              register_setting("simple_masonry_settings_section", "simple_masonry_shortcode");
